function Compo74LS174() {
    ...
    this.pinName = new Array("-MR", "D5", "D4", "D3", "D2", "D1", "D0",  "GND", "CP", "Q0", "Q1","Q2", "Q3", "Q4", "Q5","VCC");
    ...
    this.pinFunction = new Array(10, 0, 0, 0, 0, 0, 0, 2, 10, 1, 1, 1, 1, 1, 1, 3);
...
Compo74LS174.prototype.beReady = function () {
...
Compo74LS174.prototype.input = function (pinNo, value) {
    ...
    if (pinNo == 8 && oldv == 0 && value == 1 && this.pinValue[0] == 1) {
        return this.beReady();
    } else {
        return false;
    }
...
Compo74LS174.prototype.work = function () {
    var i;
    if (this.pinValue[0] == 0) {
        for (i = 1; i <= 6; i++) this.pinValue[15 - i] = 0;
    } else {
        for (i = 1; i <= 6; i++) this.pinValue[15 - i] = this.pinValue[i];
    }
}

Compo74LS174.prototype.reset = function () {
